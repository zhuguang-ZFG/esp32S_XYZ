...
export default {
  ...
  'settings.validServerUrl': 'Vui lòng nhập địa chỉ máy chủ hợp lệ bắt đầu bằng http hoặc https',
  ...
  // Về chúng tôi
  'settings.aboutApp': 'Về LiMa Nebula',
  'settings.aboutContent': 'LiMa Nebula\n\nỨng dụng quản lý di động đa nền tảng được xây dựng với Vue.js 3 + uni-app, cung cấp quản lý thiết bị, cấu hình đại lý và các chức năng khác cho phần cứng thông minh LiMa Nebula.\n\n© 2025 donglicao.com {version}',
  ...
  'deviceConfig.connectToDlcHotspot': 'Vui lòng kết nối với điểm phát sóng DLC trước',
  'deviceConfig.detecting': 'Đang phát hiện...',
  'deviceConfig.reDetect': 'Phát hiện lại',
  'deviceConfig.alreadyConnected': 'Đã kết nối với điểm phát sóng DLC',
  ...
  'deviceConfig.bringPhoneCloseToDlcDevice': 'Đưa điện thoại lại gần thiết bị DLC (khoảng cách 1-2 mét)',
  'deviceConfig.duringAudioPlaybackDlcWillReceive': 'Trong khi phát âm thanh, DLC sẽ nhận và giải mã thông tin cấu hình',
  ...
  'deviceConfig.connectDlcHotspot': 'Vui lòng kết nối với điểm phát sóng DLC',
  ...
  'deviceConfig.connectedDlcHotspot': 'Đã kết nối với điểm phát sóng DLC',
  ...
  'deviceConfig.pleaseDisconnectDlcHotspot': 'Vui lòng ngắt kết nối khỏi điểm phát sóng DLC',
  ...
  'deviceConfig.phoneConnectDlcHotspot': 'Điện thoại kết nối với điểm phát sóng DLC',
