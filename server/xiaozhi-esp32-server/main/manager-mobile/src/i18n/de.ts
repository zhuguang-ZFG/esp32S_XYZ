...
export default {
  ...
  'deviceConfig.connectToDlcHotspot': 'Bitte verbinden Sie sich zuerst mit dem DLC Hotspot',
  'deviceConfig.detecting': 'Erkennen...',
  'deviceConfig.reDetect': 'Erneut erkennen',
  'deviceConfig.alreadyConnected': 'Mit DLC Hotspot verbunden',
  ...
  'deviceConfig.bringPhoneCloseToDlcDevice': 'Bringen Sie das Telefon in die Nähe des DLC Geräts (1-2 Meter Entfernung)',
  'deviceConfig.duringAudioPlaybackDlcWillReceive': 'Während der Audio-Wiedergabe empfängt DLC und dekodiert Konfigurationsinformationen',
  ...
  'deviceConfig.connectDlcHotspot': 'Bitte verbinden Sie sich mit dem DLC Hotspot',
  ...
  'deviceConfig.connectedDlcHotspot': 'Mit DLC Hotspot verbunden',
  ...
  'deviceConfig.pleaseDisconnectDlcHotspot': 'Bitte trennen Sie sich vom DLC Hotspot',
  ...
  'deviceConfig.phoneConnectDlcHotspot': 'Telefon mit DLC Hotspot verbinden',
