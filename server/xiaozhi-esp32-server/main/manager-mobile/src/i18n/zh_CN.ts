...
export default {
  ...
  'deviceConfig.scanningHint': '正在扫描附近的 Wi-Fi…',
  'deviceConfig.selectNetworkFirst': '请先选择 Wi-Fi 网络',
  'deviceConfig.passwordRequired': '加密网络需要输入密码',
  'deviceConfig.retry': '重试',
  ...
  'v2.deviceList.provisionDevice': '配置网络',
  ...
  'v2.detail.voiceStreamTitle': '按住说话（实时转写）',
  'v2.detail.voiceStreamHint': '松开后结束录音；转写结果可用于后续任务确认。',
  'v2.detail.voiceStreamHold': '按住说话',
  'v2.detail.voiceStreamRecording': '录音中…',
  'v2.detail.deliveryUnavailableTitle': '任务未下发到设备',
  'v2.deviceList.bindTokenSaved': '绑定成功，设备令牌已保存',
  ...
  'v2.detail.galleryUpload': '上传图片',
  'v2.detail.galleryRefresh': '刷新图库',
  'v2.detail.galleryEmpty': '暂无图片，先上传一张吧',
  'v2.detail.gallerySelectFirst': '请先选择一张图库图片',
  'v2.detail.galleryDrawSelected': '绘制所选图片',
  'v2.detail.galleryDrawSubmitted': '图库绘图已提交',
  'v2.detail.galleryLoadFailed': '图库加载失败',
  'v2.detail.galleryUploadFailed': '图库上传失败',
  'v2.detail.galleryUploadSuccess': '已上传到图库',
  'v2.detail.galleryDeleted': '已从图库删除',
  'v2.detail.galleryDeleteConfirm': '确定从图库删除这张图片吗？',
  'v2.detail.galleryDownloadFailed': '获取图片下载地址失败',
  ...
  'v2.detail.deviceBusy': '设备正忙',
  'v2.detail.deviceBusyHint': '当前任务正在执行，请等待完成后再发送新指令。',
  'v2.detail.deviceBusyLabel': '设备忙碌中',

  // UI 优化(2026-07-20):任务状态 / 确认弹窗 / 分组 / 反馈
  'v2.detail.taskEmpty': '暂无进行中任务',
  'v2.detail.taskFailedHint': '任务失败，可重新提交或查看设备日志',
  'v2.detail.taskRetry': '去重试',
  'v2.detail.phaseIdle': '空闲',
  'v2.detail.phaseRunning': '执行中',
  'v2.detail.phaseAccepted': '已接受',
  'v2.detail.phaseProgress': '进行中',
  'v2.detail.phaseDone': '已完成',
  'v2.detail.phaseFailed': '失败',
  'v2.detail.phaseCancelled': '已取消',
  'v2.detail.phaseRejected': '已拒绝',
  'v2.detail.homeConfirm': '确定让设备回原点吗？请确认设备周围无障碍物。',
  'v2.detail.transferConfirmRequest': '确定将设备 {device} 转赠给 {phone} 吗？转赠后设备归属将变更。',
  'v2.detail.transferConfirmCancel': '确定取消转赠 #{id} 吗？',
  'v2.detail.transferConfirmAccept': '确定接受转赠 #{id} 吗？设备将归入你的账户。',
  'v2.detail.transferTo': '转赠给',
  'v2.detail.revokeShareConfirm': '确定撤销该分享吗？对方将立即失去访问权限。',
  'v2.detail.rejectConfirm': '确定拒绝该语音任务吗？',
  'v2.detail.copy': '复制',
  'v2.detail.copied': '分享码已复制',
  'v2.detail.wssLog': '设备日志',
  'v2.detail.wsBannerText': '实时连接已断开，设备状态可能不是最新',
  'v2.detail.wsReconnect': '重新连接',
  'v2.detail.paperLabel': '纸张',
  'v2.detail.penLabel': '画笔',
  'v2.detail.selfCheckRunning': '自检进行中…',
  'v2.detail.offlineCannotCheck': '设备离线，无法开始自检',
  'v2.detail.galleryUploadFirst': '上传第一张',
  'v2.detail.voiceStreamTranscribing': '识别中…',
  'v2.detail.rawParams': '原始参数',
  'v2.detail.paramText': '写字内容',
  'v2.detail.paramPrompt': '绘图描述',
  'v2.detail.capWriteText': '写字',
  'v2.detail.capDraw': '绘图',
  'v2.detail.capHome': '回原点',
  'v2.detail.capPause': '暂停',
  'v2.detail.capResume': '继续',
  'v2.detail.capRunPath': '运行路径',
  ...
  'settings.notificationsNotConfigured': '通知模板未配置，请联系管理员',
  ...
  'v2.deviceList.loadFailed': '加载设备列表失败',
  ...
  'v2.deviceList.pauseConfirm': '确定向设备 {device} 发送「暂停」吗？当前任务将被软暂停（非急停/ESTOP）。',
  'v2.deviceList.acceptConfirm': '确定接受设备 {device} 的转赠吗？',
  'v2.deviceList.offlineCannotControl': '设备离线，无法操作',
  'v2.deviceList.emptyHint': '先为设备配网，再用 SN + 绑定码添加',
  'v2.deviceList.retryLoad': '重新加载',
  ...
  // Create page
  'create.title': 'AI 绘画',
  'create.aiDrawTab': 'AI 绘画',
  'create.imageDrawTab': '图片绘画',
  'create.subModeText': '文生图',
  'create.subModeImage': '图生图',
  ...
  'create.submitAiDraw': '生成图片',
  'create.submitImageDraw': '开始绘画',
  'create.referenceImage': '参考图',
  'create.selectReferenceImage': '选择参考图',
  'create.pleaseSelectReferenceImage': '请选择参考图',
  'create.pleaseSelectImage': '请选择图片',
  'create.chooseFromAlbum': '从相册选择',
  'create.chooseFromGallery': '从素材库选择',
  'create.uploadImage': '上传图片',
  'create.gallery': '素材库',
  'create.galleryEmpty': '素材库为空',
  'create.noReferenceImageHint': '图生图需要一张参考图',
  'create.imageDrawHint': '选择图片后下发到设备直接绘制',
  ...
  'workshop.aiCreate': 'AI 绘画',
  'workshop.aiDraw': 'AI 绘画',
  'workshop.aiDrawDesc': '输入创意，AI 生成图案发送到绘图机',
  'workshop.imageDraw': '图片绘画',
  'workshop.imageDrawDesc': '选择图片，直接下发到绘图机',
