...
export default {
  ...
  'v2.deviceList.enterSn': '请输入设备SN',
  'v2.deviceList.enterCode': '请输入激活码',
  'v2.deviceList.confirm': '确认绑定',
  'v2.deviceList.cancel': '取消',
  'v2.deviceList.statusActive': '在线',
  'v2.deviceList.statusOffline': '离线',
  ...
  'v2.deviceDetail.noTask': '暂无任务',
  'v2.deviceDetail.connectAndSubscribe': '连接并订阅',
  'v2.deviceDetail.toastLoginFailed': '登录失败',
  'v2.deviceDetail.toastBindFailed': '绑定失败',
