...
export default {
  ...
  'v2.detail.voiceSubmitted': '语音指令已提交',
  ...
  // Voice command (按住说话语音控制)
  'voice.title': '语音控制',
  'voice.hint': '按住说话，松开后自动识别并生成指令',
  'voice.holdToSpeak': '按住说话',
  'voice.recording': '正在录音…',
  'voice.transcribing': '识别中…',
  'voice.dispatching': '派发中…',
  'voice.confirmTitle': '确认指令',
  'voice.recognizedText': '识别文本',
  'voice.editTextPlaceholder': '可编辑纠正识别结果',
  'voice.parsedIntent': '解析意图',
  'voice.targetDraw': '绘图机',
  'voice.targetWrite': '写字机',
  'voice.actionDraw': '画：',
  'voice.actionWrite': '写：',
  'voice.actionHome': '归零',
  'voice.switchToDraw': '改为绘图机',
  'voice.switchToWrite': '改为写字机',
  'voice.confirmDispatch': '确认派发',
  'voice.cancel': '取消',
  'voice.micDenied': '麦克风权限被拒绝，请在设置中开启',
  'voice.recordFailed': '录音失败，请重试',
