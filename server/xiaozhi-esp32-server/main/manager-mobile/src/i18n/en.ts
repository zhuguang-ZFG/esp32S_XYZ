...
export default {
  ...
  'deviceConfig.scanningHint': 'Scanning nearby Wi-Fi…',
  'deviceConfig.selectNetworkFirst': 'Select a Wi-Fi network first',
  'deviceConfig.passwordRequired': 'Password required for this encrypted network',
  'deviceConfig.retry': 'Retry',
  ...
  'v2.detail.galleryTitle': 'Gallery Draw',
  'v2.detail.galleryDesc': 'Tap to select, tap again to preview, long-press to delete',
  'v2.detail.galleryUpload': 'Upload Image',
  'v2.detail.galleryRefresh': 'Refresh Gallery',
  'v2.detail.galleryEmpty': 'No images yet. Upload one first.',
  'v2.detail.gallerySelectFirst': 'Please select a gallery image first',
  'v2.detail.galleryDrawSelected': 'Draw Selected Image',
  'v2.detail.galleryDrawSubmitted': 'Gallery draw task submitted',
  'v2.detail.galleryLoadFailed': 'Failed to load gallery',
  'v2.detail.galleryUploadFailed': 'Gallery upload failed',
  'v2.detail.galleryUploadSuccess': 'Uploaded to gallery',
  'v2.detail.galleryDeleted': 'Removed from gallery',
  'v2.detail.galleryDeleteConfirm': 'Remove this image from gallery?',
  'v2.detail.galleryDownloadFailed': 'Failed to get image download URL',
  ...
  'v2.detail.deviceBusyLabel': 'Device busy',

  // UI polish (2026-07-20): task status / confirm dialogs / groups / feedback
  'v2.detail.taskEmpty': 'No task in progress',
  'v2.detail.taskFailedHint': 'Task failed. Resubmit or check device logs.',
  'v2.detail.taskRetry': 'Retry',
  'v2.detail.phaseIdle': 'Idle',
  'v2.detail.phaseRunning': 'Running',
  'v2.detail.phaseAccepted': 'Accepted',
  'v2.detail.phaseProgress': 'In progress',
  'v2.detail.phaseDone': 'Done',
  'v2.detail.phaseFailed': 'Failed',
  'v2.detail.phaseCancelled': 'Cancelled',
  'v2.detail.phaseRejected': 'Rejected',
  'v2.detail.homeConfirm': 'Send device to home position? Make sure the area around the device is clear.',
  'v2.detail.transferConfirmRequest': 'Transfer device {device} to {phone}? Ownership will change after acceptance.',
  'v2.detail.transferConfirmCancel': 'Cancel transfer #{id}?',
  'v2.detail.transferConfirmAccept': 'Accept transfer #{id}? The device will move to your account.',
  'v2.detail.transferTo': 'To',
  'v2.detail.revokeShareConfirm': 'Revoke this share? The recipient loses access immediately.',
  'v2.detail.rejectConfirm': 'Reject this voice task?',
  'v2.detail.copy': 'Copy',
  'v2.detail.copied': 'Share token copied',
  'v2.detail.wssLog': 'Device Log',
  'v2.detail.wsBannerText': 'Realtime connection lost. Device status may be stale.',
  'v2.detail.wsReconnect': 'Reconnect',
  'v2.detail.paperLabel': 'Paper',
  'v2.detail.penLabel': 'Pen',
  'v2.detail.selfCheckRunning': 'Self-check running…',
  'v2.detail.offlineCannotCheck': 'Device offline; self-check unavailable',
  'v2.detail.galleryUploadFirst': 'Upload the first one',
  'v2.detail.voiceStreamTranscribing': 'Transcribing…',
  'v2.detail.rawParams': 'Raw params',
  'v2.detail.paramText': 'Text',
  'v2.detail.paramPrompt': 'Prompt',
  'v2.detail.capWriteText': 'Write',
  'v2.detail.capDraw': 'Draw',
  'v2.detail.capHome': 'Home',
  'v2.detail.capPause': 'Pause',
  'v2.detail.capResume': 'Resume',
  'v2.detail.capRunPath': 'Run path',
  ...
  'v2.deviceList.pauseConfirm': 'Send pause to device {device}? The running task will soft-pause (not emergency stop / ESTOP).',
  'v2.deviceList.acceptConfirm': 'Accept transfer of device {device}?',
  'v2.deviceList.offlineCannotControl': 'Device offline, action unavailable',
  'v2.deviceList.emptyHint': 'Provision Wi-Fi first, then add with SN + binding code',
  'v2.deviceList.retryLoad': 'Reload',
