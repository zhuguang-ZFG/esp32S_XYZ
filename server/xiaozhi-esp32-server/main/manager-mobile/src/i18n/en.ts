...
export default {
  ...
  'v2.detail.voiceSubmitted': 'Voice command submitted',
  ...
  'v2.detail.chatHistory': 'Chat History',
  'v2.detail.voiceprintMgmt': 'Voiceprint Management',
  'v2.detail.manageAgents': 'Manage Agents',
  ...
  'voice.hint': 'Hold the button and speak, e.g. "draw a cat" / "write hello"',
  'voice.holdToSpeak': 'Hold to Speak',
  'voice.recording': 'Recording…',
  'voice.transcribing': 'Recognizing…',
  'voice.dispatching': 'Dispatching…',
  'voice.confirmTitle': 'Confirm Command',
  'voice.recognizedText': 'Recognized Text',
  'voice.editTextPlaceholder': 'Edit the recognized text',
  'voice.parsedIntent': 'Parsed Intent',
  'voice.targetDraw': 'Drawing Machine',
  'voice.targetWrite': 'Writing Machine',
  'voice.actionDraw': 'Draw: ',
  'voice.actionWrite': 'Write: ',
  'voice.actionHome': 'Home',
  'voice.switchToWrite': 'Switch to Writing Machine',
  'voice.switchToDraw': 'Switch to Drawing Machine',
  'voice.confirmDispatch': 'Confirm',
  'voice.cancel': 'Cancel',
  'voice.micDenied': 'Microphone permission denied. Enable it in settings.',
  'voice.recordFailed': 'Recording failed, please retry',
  'voice.transcribeFailed': 'Recognition failed, please retry',
