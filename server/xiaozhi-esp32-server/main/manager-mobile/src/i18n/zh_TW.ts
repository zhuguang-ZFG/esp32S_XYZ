...
export default {
  ...
  'device.edgeDebugTitle': 'Edge-A 事件流（調試）',
  'device.edgeDebugPlaceholder': 'device_id，例如 dev_SN001',
  'device.edgeDebugConnect': '連接並訂閱',
  'device.edgeDebugDisconnect': '斷開',
  'device.edgeDebugNeedLogin': '請先登錄',
  'device.edgeDebugNeedDeviceId': '請填寫 device_id',
  ...
  'deviceConfig.connectToDlcHotspot': '請先連接DLC熱點 (DLC-XXXXXX)',
  'deviceConfig.detecting': '檢測中...',
  'deviceConfig.reDetect': '重新檢測',
  'deviceConfig.alreadyConnected': '已連接DLC熱點',
  ...
  'deviceConfig.bringPhoneCloseToDlcDevice': '將手機靠近DLC設備（距離1-2米）',
  'deviceConfig.duringAudioPlaybackDlcWillReceive': '音頻播放時，DLC會接收並解碼配網信息',
  ...
  'deviceConfig.connectDlcHotspot': '請連接DLC熱點',
  ...
  'deviceConfig.connectedDlcHotspot': '已連接DLC熱點',
  ...
  'deviceConfig.pleaseDisconnectDlcHotspot': '請斷開DLC熱點連接',
  ...
  'deviceConfig.phoneConnectDlcHotspot': '手機連接DLC熱點',
